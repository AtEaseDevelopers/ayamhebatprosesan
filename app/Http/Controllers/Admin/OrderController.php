...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $orders = $orders->with('customer')->paginate(15);
        ...
        $drivers_arr = [];
        $drivers = DB::table('drivers')->where('archived', false)->select('id', 'lorry_number')->get()->toArray();
    ...
    public function update_order_products_weight(Request $request)
    {
        ...
        PdfHelper::UpdateDeliveryOrder($order, false, $request['do_date']);
    ...
    public function export(Request $request)
    {
        ...
        foreach ($orders as $key => $order) {
            $data[] = [
                ...
                'payment_method' => __('user.payment_method.'.$order->payment_method),
