    ...
    function () {
        ...
        Route::group(
            ...
            function () {
                ...
                Route::post('/customer/update-password/{customer}', 'EditCustomerController@updatePassword')->name('customer.update-password');
                ...
                Route::post('/archieve/{id}', 'LorryController@archive')->name('lorry.archive');
                Route::post('/unarchieve/{id}', 'LorryController@unarchive')->name('lorry.unarchive');
