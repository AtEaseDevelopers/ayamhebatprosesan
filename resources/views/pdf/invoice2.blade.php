...
<body>
    ...
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
            <td style="width: 20%; text-align: center; vertical-align: middle;">
                <img src="{{ public_path('assets/images/logo.jpg') }}" alt="" style="height: 100px; width: 100px;">
            </td>
            <td style="text-align: center; width: 60%;">
                <span style="font-size: 22px; font-weight: 700;">AYAM HEBAT PROSESAN SDN. BHD.</span><br>
                <span style="font-size: 12px;">(1130071.K)</span><br>
                <span style="font-size: 16px;">Lot 698, Mk 12, Jalan Bukit Tambun,</span><br>
                <span style="font-size: 16px;">Juru Estate, Juru, 14000 Bukit Mertajam, Pulau Pinang.</span><br>
                <span style="font-size: 16px;">Phone : 012-496 2977 / 017-411 2599 / 012-425 8872.</span><br>
                <span style="font-size: 16px;">A/C Dept : 012-522 2872</span>
            </td>
            ...
            <td style="width: 30%; vertical-align: text-top;">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <span style="font-size: 14px;">{{ $do_no ?? '' }}</span><br>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>:</td>
                        <td>
                            <span style="font-size: 14px;">{{ $order->po_no ?? '' }}</span><br>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="text-align: center; padding: 10px 0;">
                            <img src="{{ public_path('assets/images/qr.jpeg') }}" alt="QR Code" style="height: 100px; width: 100px;">
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table style="width: 100%; font-family: sans-serif; border-collapse: collapse; margin: 30px 0 0 0;">
        <tr style="margin: 0 0 25px 0;">
            <td style="padding: 0 0 50px 0; text-align: center;">
                <span style="font-size: 14px; font-weight: 700;">AYAM HEBAT PROSESAN SDN</span>
            </td>
            <td style="width: 10%;"></td>
            <td></td>
        </tr>
        <tr>
            <td style="font-size: 14px; text-align: center; border-top: solid 1px black; padding: 5px 0 0 0;">ISSUED BY</td>
            <td style="width: 10%;"></td>
            <td style="font-size: 14px; text-align: center; border-top: solid 1px black; padding: 5px 0 0 0;">RECEIVED BY</td>
        </tr>
    </table>
</body>
</html>