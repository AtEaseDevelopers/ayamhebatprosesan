                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" class="form-control @error('po_no') is-invalid @enderror" name="po_no" id="po_no" value="{{ $order->po_no }}" placeholder="Enter PO No. (optional)" maxlength="50">
                                    </div>
                                </div>
                                <!--<div class="col-md-6">-->
                                <!--    <div class="mb-4">-->
