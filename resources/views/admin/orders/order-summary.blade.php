                ...
                <div>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="{{ $invoice_url }}#toolbar=0" data-url="{{ $invoice_download_url }}" class="dropdown-item view-pdf">
                                    {{ __('order.file.invoice') }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ $invoice2_url }}#toolbar=0" data-url="{{ $invoice2_download_url }}" class="dropdown-item view-pdf">
                                    {{ __('order.file.invoice2') }}
                                </a>
                            </li>
                            <li>
                                <a href="{{ $delivery_order_url }}#toolbar=0" data-url="{{ $delivery_order_download_url }}" class="dropdown-item view-pdf">
                                    {{ __('order.file.delivery-order') }}
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-12 mt-3 text-right">
                        <a id="downloadLink" class="btn btn-primary text-right" href=""><i class="fa fa-download"></i> Download</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".view-pdf").click(function() {
                ...
                $("#downloadLink").attr("href", $(this).data('url'));
