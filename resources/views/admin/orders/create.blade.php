                    ...
                    <div class="card-body">
                        ...
                        <div id="customer_info" class="d-none">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        <label class="mb-2" for="po_no">PO No.</label>
                                        <input type="text" class="form-control @error('po_no') is-invalid @enderror" name="po_no" id="po_no" value="{{ old('po_no') }}" placeholder="Enter PO No. (optional)" maxlength="50">
                                    </div>
                                </div>
                                <!--<div class="col-md-6">-->
                                <!--    <div class="mb-4">-->
...
@section('script')
    ...
    <script>
        ...
        $('body').on('change', '.products', function() {
            let currentCount = $('.products:checked').length
            $(this).attr('data-order', currentCount + 1)
        })
    </script>
