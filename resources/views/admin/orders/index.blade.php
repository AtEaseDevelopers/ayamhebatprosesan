                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item view-pdf" href="{{ $order->invoice_url }}#toolbar=0" data-url="{{ $order->invoice_download_url }}">View Invoice</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item view-pdf" href="{{ $order->delivery_order_url }}#toolbar=0">View DO</a>
                                                    </li>
                                                    <li>
