                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <select class="form-select" name="category" id="filterCategory">
                                        ...
                                        @foreach ($category_list as $category)
                                            @if ($category)
                                                <option value="{{ $category }}"{{ ($input['category'] ?? '') == $category ? ' selected' : '' }}>
                                                    {{ $category }}
                                                </option>
                                            @endif
                                        @endforeach
                            ...
                            <tbody>
                                @foreach ($users as $index => $user)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control fast_link mb-2" style="width: 150px;" value="{{ $user->fast_login_link }}" readonly />
                                            <p>
                                        ...
                                        <td>{{ $user->email ?: '--' }}</td>
                                        <td>{{ $user->category ?: '--' }}</td>
                                        <!--<td>{{ implode(', ', $user->payment_method_text) }}</td>-->
                                        <td>{{ $user->area ?? '-' }}</td>
                                        <td>{{ $user->lorry_number ?? '-' }}</td>
