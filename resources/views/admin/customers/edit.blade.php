...
@section('content')
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select @error('area') is-invalid @enderror"  id="area" name="area">
                                        ...
                                        @foreach ($areaList as $area)
                                            <option value="{{ $area }}" {{ $customer->area == $area ? 'selected' : '' }}>
                                                {{ $area }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="form-check form-switch mt-2">
                                        <input type="hidden" name="status" id="statusHidden" value="{{ old('status', $customer->status) }}">
                                        <input class="form-check-input" type="checkbox" role="switch" id="statusSwitch" {{ old('status', $customer->status) == 'active' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="statusSwitch" id="statusLabel">{{ old('status', $customer->status) == 'active' ? 'Active' : 'Inactive' }}</label>
                                    </div>
                                </div>
                                <div class="mb-4">
    ...
    <div class="card shadow no-border">
        <div class="card-body">
            ...
            <form action="{{ route('admin.customer.update-password', $customer->id) }}" method="POST" class="form-wrapper">
                @csrf
                <div class="mb-4">
