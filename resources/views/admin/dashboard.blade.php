                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        ...
                        <div class="status-filter">
                            ...
                            <button class="btn btn-sm btn-primary status-filter-button mb-1" data-status="{{ __('order.status.cancelled') }}">{{ __('order.status.cancelled') }}</button>
                            <button class="btn btn-sm btn-primary status-filter-button mb-1" data-status="{{ __('order.status.processing') }}">{{ __('order.status.processing') }}</button>
                            ...
                            <button class="btn btn-sm btn-primary status-filter-button mb-1" data-status="{{ __('order.status.completed') }}">{{ __('order.status.completed') }}</button>
                            <button class="btn btn-sm btn-success mb-1 status-action-button" data-to_status="processing" data-status="{{ __('order.status.processing') }}" style="display: none;">Change Status To {{ __('order.status.processing') }}</button>
                            <button class="btn btn-sm btn-success mb-1 status-action-button" data-to_status="completed" data-status="{{ __('order.status.completed') }}" style="display: none;">Change Status To {{ __('order.status.completed') }}</button>
